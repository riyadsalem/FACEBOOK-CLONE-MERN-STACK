...
export default function DisplayAccessibility({ setVisible }) {
  ...
  const { darkTheme } = useSelector((store) => ({ ...store.rootReducer }));
  return (
    <div className="absolute_wrap">
      ...
      <div className="mmenu_main">
        ...
        <div className="mmenu_col">
          ...
          <span className="mmenu_span2">
            Adjust the appear of Facebook to reduce glare and give your eyes a
            breal.
          </span>
        </div>
      </div>
      ...
      <label htmlFor="compactOf" className="hover1">
        <span>Off</span>
        <input type="radio" name="compact" id="compactOf" />
      </label>
